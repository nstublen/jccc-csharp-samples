...
SELECT CustomerID, Name, Address, City, State, ZipCode FROM Customers WHERE (CustomerID = @CustomerID) ORDER BY Name";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FillAll(CustomersDataSet.CustomersDataTable dataTable) {
        ...
        public virtual CustomersDataSet.CustomersDataTable GetDataAll() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CustomersDataSet.CustomersDataTable dataTable = new CustomersDataSet.CustomersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
